                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <span>{{scope.row.state | orderStatus}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                            align="right">
            ...
            <el-dialog title="收货地址" :visible.sync="dialogFormVisible">
                <el-form :model="form">
                    ...
                    <el-form-item label="订单信息" :label-width="formLabelWidth">
                        <el-input v-model="form.mess" autocomplete="off"></el-input>
                    </el-form-item>
    ...
    const app = new Vue({
        ...
        methods: {
            handleCurrentChange:function(){
                axios.get('/jsp_war_exploded/AdminOrderlist',{
                    params: {
            ...
            handleEdit(index, row) {
                ...
                axios.get("/jsp_war_exploded/AdminOrderEdit",{
                    params: {
                        id: row.id
                    }
                }).then((res)=>{
            ...
            handleDelete(index, row) {
                console.log(index, row);
                axios.get("/jsp_war_exploded/AdminOrderDel", {
                    params: {
                        id:row.id
                    }
                }).then((res)=>{
            ...
            add() {
                ...
                axios.get("/jsp_war_exploded/AdminOrderAdd", {
                    params: {
                        logname:this.form.logname,
                        mess:this.form.password,
                        sum: this.form.phone,
                    }
                }).then((res)=>{
                    console.log(res)
